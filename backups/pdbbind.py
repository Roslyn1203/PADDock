...
def construct_loader(args, t_to_sigma):
    ...
    train_dataset = PDBBind(cache_path=args.cache_path, split_path=args.split_val, keep_original=True,
                            num_conformers=args.num_conformers, **common_args)
    val_dataset = PDBBind(cache_path=args.cache_path, split_path=args.split_test, keep_original=True, **common_args)
